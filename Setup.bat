...
if "%command%"=="stop" (
    ...
    start D:\AutoHotkey\AutoHotkey.exe .\Keys\Fxx.ahk        /f /r  stop
    echo stop .\Keys\Fxx.ahk
...
if "%command%"=="start" (
    ...
    start D:\AutoHotkey\AutoHotkey.exe .\Keys\Fxx.ahk        /f /r
    echo start .\Keys\Fxx.ahk
